            ...
            {[
              {
                icon: BookOpen,
                title: 'Spirituel',
                desc: "Par la puissance du Coran et des invocations, mais aussi en créant et en raffermissant une connexion profonde et ancrée avec Allah — une relation solide, fondée sur la confiance en Allah.",
