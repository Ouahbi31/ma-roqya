      ...
      <div className="mx-auto max-w-5xl px-4">
        ...
        <div className="mt-8 md:mt-14 grid gap-6 md:gap-8 md:grid-cols-2">
          ...
          <div className="card-islamic relative flex flex-col border-2 border-gold/40 p-6 md:p-8 opacity-80 overflow-hidden">
            ...
            <div className="absolute top-8 -right-10 w-48 bg-gray-500/75 text-white text-[10px] font-bold tracking-widest text-center py-1.5 rotate-45 uppercase shadow pointer-events-none z-10">
              Bientôt disponible
            </div>
